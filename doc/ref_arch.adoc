...
* A sample default jmeter load test definition file is included in: _$REF_ARCH_HOME/loadtest/src/test/jmeter/ref_arch.jmx
...
* cd to $REF_ARCH_HOME/loadtest and execute:  mvn clean verify
